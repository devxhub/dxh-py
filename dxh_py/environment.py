...
from dxh_py.exceptions import UnknownExtension
...
class ExtensionLoaderMixin:
    ...
    def __init__(self, *, context: dict[str, Any] | None = None, **kwargs: Any) -> None:
        ...
        2. Reads extensions set in the dxh_py.json _extensions key.
    ...
    def _read_extensions(self, context: dict[str, Any]) -> list[str]:
        ...
        """
        try:
            extensions = context['dxh_py']['_extensions']
        except KeyError:
            return []
        else:
...
class StrictEnvironment(ExtensionLoaderMixin, Environment):
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Set the standard dxh_py StrictEnvironment.

        Also loading extensions defined in dxh_py.json's _extensions key.
        """
