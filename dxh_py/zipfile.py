...
from dxh_py.exceptions import InvalidZipRepository
from dxh_py.prompt import prompt_and_delete, read_repo_password
from dxh_py.utils import make_sure_path_exists
...
def unzip(
    ...
    This will download the zipfile to the dxh_py repository,
    and unpack into a temporary directory.

    :param zip_uri: The URI for the zipfile.
    :param is_url: Is the zip URI a URL or a file?
    :param clone_to_dir: The dxh_py repository directory
